...
/** Quinnox / QAScan themed scroll-parallax sections. Logic ported 1:1 from a
...
const sections: ParallaxSection[] = [
  {
    ...
    lead: "QAScan captures capability across teams, practices, tools and governance through a structured, governed assessment - so every result is comparable and defensible.",
  ...
  },
  {
    ...
    lead: "QAScan closes the loop - approved access, dashboards and focused recommendation tracking take teams from assessment to delivered improvement.",
